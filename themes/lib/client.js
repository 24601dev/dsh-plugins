  ...
  factory: (require) => {
    ...
    const THEMES = [
      ...
      },
      {
        id: "militech",
        label: "Militech",
        blurb: "Night City contractor. Black steel, hazard chartreuse.",
        face: "'Chakra Petch'",
        codeFace: "Menlo",
        faceLabel: "Chakra Petch / Menlo",
        swatch: { light: "#f2f4e8", dark: "#080904" },
        accent: { light: "#606c0a", dark: "#dce828" },
        // Light: field-manual paper. Dark is the canonical HUD — near-black
        // with an olive cast, yellow-chartreuse chrome. Button fills use a
        // deeper olive so white label text stays above 4.5:1; the neon
        // chartreuse is reserved for borders, marks, and glow (white-on-neon
        // fails AA). Dark accent rgb(220, 232, 40) on base is 15.0:1.
        light: {
          "bg-base": "rgb(242, 244, 232)",
          "bg-layer-1": "rgb(236, 238, 224)",
          "bg-layer-2": "rgb(224, 228, 208)",
          "bg-layer-3": "rgb(210, 216, 188)",
          "bg-overlay": "rgb(248, 250, 240)",
          "bg-module-platform": "rgb(224, 228, 208)",
          "border-l1": "rgba(96, 108, 10, 0.12)",
          "border-l2": "rgba(96, 108, 10, 0.32)",
          "label-primary": "rgb(16, 18, 8)",
          "label-secondary": "rgb(58, 64, 36)",
          "label-tertiary": "rgb(102, 110, 74)",
          "brand-primary": "rgb(16, 18, 8)",
          "state-business-primary": "rgb(96, 108, 10)",
          "interactive-bg-hover": "rgba(96, 108, 10, 0.1)",
          "sidebar-fill": "rgb(224, 228, 208)",
          "input-major": "rgb(230, 232, 216)",
          "tip": "rgb(230, 232, 216)",
          "button-info-fill": "rgb(96, 108, 10)",
          "button-info-hover": "rgb(118, 130, 16)",
          "button-contrast-fill": "rgb(96, 108, 10)",
          "button-elevated-fill": "rgba(96, 108, 10, 0.1)",
          "button-floating-fill": "rgba(96, 108, 10, 0.08)",
          "button-floating-hover": "rgba(96, 108, 10, 0.16)",
          "button-ghost-active-border": "rgba(96, 108, 10, 0.32)",
          "button-ghost-active-fill": "rgba(96, 108, 10, 0.12)",
          "button-ghost-active-hover": "rgba(96, 108, 10, 0.2)",
          "button-primary-dimmed": "rgba(96, 108, 10, 0.1)",
          "button-primary-fill": "rgb(96, 108, 10)",
          "button-primary-hover": "rgb(118, 130, 16)",
          "button-tool-bar-fill": "rgba(96, 108, 10, 0.12)",
          "button-tool-bar-hover": "rgba(96, 108, 10, 0.22)",
          "button-tool-bar-fill-invisible": "rgba(16, 18, 8, 0.08)",
          "interactive-bg-hover-solid": "rgba(96, 108, 10, 0.1)",
          "selector": "rgba(96, 108, 10, 0.1)",
          "bubble": "rgba(96, 108, 10, 0.1)",
          "menu": "rgb(236, 238, 224)",
        },
        dark: {
          "bg-base": "rgb(6, 7, 4)",
          "bg-layer-1": "rgb(10, 11, 6)",
          "bg-layer-2": "rgb(16, 18, 8)",
          "bg-layer-3": "rgb(24, 26, 12)",
          "bg-overlay": "rgb(8, 9, 5)",
          "bg-module-platform": "rgb(14, 16, 8)",
          "border-l1": "rgba(220, 232, 40, 0.16)",
          "border-l2": "rgba(220, 232, 40, 0.42)",
          "label-primary": "rgb(236, 240, 220)",
          "label-secondary": "rgb(176, 186, 148)",
          "label-tertiary": "rgb(120, 130, 100)",
          "brand-primary": "rgb(236, 240, 220)",
          "state-business-primary": "rgb(220, 232, 40)",
          "interactive-bg-hover": "rgba(220, 232, 40, 0.12)",
          "sidebar-fill": "rgb(4, 5, 2)",
          "input-major": "rgb(8, 9, 5)",
          "tip": "rgb(8, 9, 5)",
          "button-info-fill": "rgb(102, 110, 12)",
          "button-info-hover": "rgb(128, 138, 18)",
          "button-contrast-fill": "rgb(102, 110, 12)",
          "button-elevated-fill": "rgba(220, 232, 40, 0.12)",
          "button-floating-fill": "rgba(4, 5, 2, 0.55)",
          "button-floating-hover": "rgba(220, 232, 40, 0.18)",
          "button-ghost-active-border": "rgba(220, 232, 40, 0.42)",
          "button-ghost-active-fill": "rgba(220, 232, 40, 0.14)",
          "button-ghost-active-hover": "rgba(220, 232, 40, 0.24)",
          "button-primary-dimmed": "rgba(220, 232, 40, 0.12)",
          "button-primary-fill": "rgb(102, 110, 12)",
          "button-primary-hover": "rgb(128, 138, 18)",
          "button-tool-bar-fill": "rgba(220, 232, 40, 0.14)",
          "button-tool-bar-hover": "rgba(220, 232, 40, 0.26)",
          "button-tool-bar-fill-invisible": "rgba(2, 2, 0, 0.2)",
          "interactive-bg-hover-solid": "rgba(220, 232, 40, 0.14)",
          "selector": "rgba(220, 232, 40, 0.1)",
          "bubble": "rgba(220, 232, 40, 0.14)",
          "menu": "rgb(16, 18, 8)",
        },
      },
      {
        ...
        face: "Oswald",
        codeFace: "Menlo",
        faceLabel: "Oswald / Menlo",
        swatch: { light: "#f7f4f0", dark: "#000000" },
        accent: { light: "#ba0c1c", dark: "#e4222c" },
        // Canonical dark is graphic black/white with a single print red —
        // no navy, no olive, no extra hues (P5 dropped sub-colours so the
        // red would carry; P5R keeps that, using white sight-lines instead).
        // Secondary type stays achromatic. Light is the calling-card read.
        // Dark accent rgb(228, 34, 44) on true black is 4.56:1; white on
        // that fill is 4.60:1. Magenta/turquoise stay out — those are HP/MP
        // in the game, not a second brand colour.
        light: {
    ...
    // in chartreuse rather than crimson.
    ...
    function denseChatCss(sel) {
      // Chat body only: the design system's small markdown scale. Not a
      // global plugin — Arasaka and Militech HUD density, not Phantom.
      return `
${sel}{
...
`;
    ...
    function militechAtmosphere() {
      ...
      const dark = `${sel}[data-ds-dark-theme]`;
      const acid = "var(--dsw-alias-state-business-primary)";
      // Square wireframes, not Arasaka chamfers. Corner ticks and a thin
      // engineering grid are the HUD language (Breach Protocol), with a
      // yellow-black wash instead of crimson.
      const ticks = (fill) =>
        `linear-gradient(${acid},${acid}) right top/16px 2px no-repeat,` +
        `linear-gradient(${acid},${acid}) right top/2px 16px no-repeat,` +
        `linear-gradient(${acid},${acid}) left bottom/16px 2px no-repeat,` +
        `linear-gradient(${acid},${acid}) left bottom/2px 16px no-repeat,` +
        fill;
      const grid =
        "repeating-linear-gradient(0deg,rgba(220,232,40,.07) 0 1px,transparent 1px 28px)," +
        "repeating-linear-gradient(90deg,rgba(220,232,40,.07) 0 1px,transparent 1px 28px)";
      const scan =
        "repeating-linear-gradient(180deg,rgba(0,0,0,.22) 0 1px,transparent 1px 3px)";
      const wash =
        "linear-gradient(180deg, rgb(18, 20, 6) 0%, rgb(8, 9, 4) 48%, rgb(2, 2, 0) 100%)";
      const washCss =
        `background-color:rgb(2,2,0)!important;background-image:${wash}!important;` +
        "background-repeat:no-repeat!important;background-attachment:fixed!important";
      const glassFill = "rgba(4, 5, 2, 0.42)";
      const glass =
        `background:${glassFill}!important;` +
      ...
      return `
${denseChatCss(sel)}
${sel} [class*="sidebarCol"],${sel} [class*="detailsCol"],${sel} [class*="header"],${sel} button{letter-spacing:.08em}
${sel} [class*="sidebarCol"]{font-size:12px}
${sel} *,${sel} *::before,${sel} *::after{border-radius:0!important}
${sel} [class*="spinner" i],${sel} [class*="Spinner"]{border-radius:50%!important}
${sel} ::selection{background:rgba(96,108,10,.42);color:#fff}
${sel} .dshth-name{text-transform:uppercase;letter-spacing:.16em;font-weight:600}
${sel} textarea,${sel} [class$="_input"],${sel} [class$="_mirror"],${sel} [class$="_backdrop"]{letter-spacing:0!important}
${sel} [data-ref-chip],${sel} [data-composer-card] [class$="_chip"]{background:transparent!important;color:${acid};box-shadow:none}
${sel} [class*="sidebarCol"]{box-shadow:inset 3px 0 0 ${acid}}
${sel} .hHd-Xa_brand{position:relative;min-width:118px;min-height:22px}
${sel} .hHd-Xa_brand>svg{position:absolute;inset:0;width:0!important;height:0!important;opacity:0;overflow:hidden}
${sel} .hHd-Xa_brand::after{content:"";display:block;width:118px;height:22px;pointer-events:none;background:${acid};-webkit-mask:url("${MILITECH_WORDMARK_URL}") center/contain no-repeat;mask:url("${MILITECH_WORDMARK_URL}") center/contain no-repeat}
${sel} .hHd-Xa_railFish{width:24px!important;height:24px!important;background:${acid}!important;-webkit-mask:url("${MILITECH_MARK_URL}") center/contain no-repeat;mask:url("${MILITECH_MARK_URL}") center/contain no-repeat}
${sel} .hHd-Xa_railFish path{opacity:0}
${sel} .pXSMma_headline{grid-template-columns:auto auto!important}
${sel} .pXSMma_fishHitbox{display:none!important}
${sel} .pXSMma_headlineText{grid-area:1/1!important;font-size:0;line-height:0;width:180px;height:32px;background:${acid};-webkit-mask:url("${MILITECH_WORDMARK_URL}") center/contain no-repeat;mask:url("${MILITECH_WORDMARK_URL}") center/contain no-repeat}
${sel} .pXSMma_previewBadge{grid-area:1/2!important}
${sel} .hHd-Xa_root:not(.hHd-Xa_collapsed) .hHd-Xa_newSession{background:color-mix(in srgb,${acid} 14%,transparent)!important;border-color:${acid}!important;color:${acid}!important}
${sel} .hHd-Xa_root:not(.hHd-Xa_collapsed) .hHd-Xa_newSession:hover{background:color-mix(in srgb,${acid} 26%,transparent)!important}
${sel} [data-composer-card]{box-shadow:none!important;background:${ticks("var(--dsw-specific-input-major)")}!important}
${sel} [data-composer-card] button[aria-label="Send message"],${sel} [data-composer-card] button[aria-label="发送消息"]{box-shadow:0 0 14px color-mix(in srgb,${acid} 55%,transparent)}
${dark}{--dsw-shadow-lv2:none;--dsw-specific-sidebar-fill:transparent;box-shadow:inset 0 1px 0 ${acid};${washCss}}
${dark} [class*="centerCol"]{${washCss};position:relative;isolation:isolate}
${dark} [class*="centerCol"]::before{content:"";position:absolute;inset:0;pointer-events:none;z-index:-1;background-image:${grid},${scan};background-size:28px 28px,100% 4px;background-repeat:repeat,repeat;background-attachment:fixed,fixed;-webkit-mask-image:linear-gradient(180deg,transparent 0,#000 140px);mask-image:linear-gradient(180deg,transparent 0,#000 140px)}
${dark} [data-phase],${dark} .hHd-Xa_root{background:transparent!important}
${dark} .wSkVaW_composerSeat{background:linear-gradient(180deg,transparent 0,rgba(2,2,0,.35) 32px,rgb(2,2,0) 72px)!important}
${dark} [class*="detailsCol"],${dark} .wSkVaW_header{${glass}}
${dark} [class*="sidebarCol"]{background:${glassFill}!important;border-right:1px solid rgba(220,232,40,.18)}
${dark} [class*="detailsCol"]{border-left:1px solid rgba(220,232,40,.18)}
${dark} [data-composer-card]{background:${ticks(glassFill)}!important;backdrop-filter:blur(22px) saturate(1.15);-webkit-backdrop-filter:blur(22px) saturate(1.15);border:1px solid rgba(220,232,40,.22)!important}
${dark} ::selection{background:rgba(220,232,40,.55);color:#111}
@media (prefers-reduced-transparency:reduce){
${dark} [class*="sidebarCol"],${dark} [class*="detailsCol"],${dark} .wSkVaW_header,${dark} [data-composer-card]{backdrop-filter:none;-webkit-backdrop-filter:none;background:rgba(8,9,4,.92)!important}
}
`;
    }

    function phantomAtmosphere() {
      const sel = `body[${THEME_ATTR}="phantom"]`;
      const dark = `${sel}[data-ds-dark-theme]`;
      const red = "var(--dsw-alias-state-business-primary)";
      // P5 / P5R construction: sheared slabs, hard offset cutouts, a white
      // sight-line. drop-shadow survives clip-path; box-shadow does not.
      // Not Arasaka chamfers, not Militech ticks, not glow or glass.
      const slab = "polygon(16px 0,100% 0,calc(100% - 16px) 100%,0 100%)";
      const slabSm = "polygon(10px 0,100% 0,calc(100% - 10px) 100%,0 100%)";
      const dots =
        "radial-gradient(circle, rgba(255,255,255,.14) 1px, transparent 1.3px)";
      const slash =
        "linear-gradient(108deg,transparent 47.4%,#fff 47.4%,#fff 52.6%,transparent 52.6%)";
...
${sel} [class*="sidebarCol"]{font-size:12px;font-style:italic;color:#fff;box-shadow:inset 8px 0 0 ${red};border-right:2px solid #fff;background:#000!important}
${sel} *,${sel} *::before,${sel} *::after{border-radius:0!important}
${sel} [class*="spinner" i],${sel} [class*="Spinner"]{border-radius:50%!important}
${sel} ::selection{background:${red};color:#fff}
${sel} .dshth-name{text-transform:uppercase;letter-spacing:.18em;font-weight:700;font-style:italic}
${sel} .dshth-card{clip-path:${slabSm};border-width:2px;border-color:#000}
${sel} .dshth-card[aria-pressed="true"]{background:${red}!important;color:#fff;box-shadow:none;border-color:#000;filter:${cutWhite}}
${sel} .dshth-card[aria-pressed="true"] .dshth-name,${sel} .dshth-card[aria-pressed="true"] .dshth-blurb,${sel} .dshth-card[aria-pressed="true"] .dshth-face{color:#fff}
...
${sel} .hHd-Xa_root:not(.hHd-Xa_collapsed) .hHd-Xa_newSession{background:${red}!important;border:2px solid #000!important;color:#fff!important;clip-path:${slab};text-transform:uppercase;letter-spacing:.14em;filter:${cutWhite}}
${sel} .hHd-Xa_root:not(.hHd-Xa_collapsed) .hHd-Xa_newSession:hover{filter:${cutWhite} brightness(1.1)}
${sel} [data-composer-card]{box-shadow:none!important;border:2px solid #000!important;clip-path:${slab};filter:${cutRed}}
${sel} [data-composer-card] button[aria-label="Send message"],${sel} [data-composer-card] button[aria-label="发送消息"]{clip-path:${slabSm};box-shadow:none;filter:${cutBlack}}
${dark}{--dsw-shadow-lv2:none;background-color:#000!important}
${dark} [class*="centerCol"]{background-color:#000!important;position:relative;isolation:isolate}
${dark} [class*="centerCol"]::before{content:"";position:absolute;inset:0;pointer-events:none;z-index:-1;opacity:.22;background-image:${slash},${dots};background-size:100% 100%,9px 9px;background-repeat:no-repeat,repeat}
${dark} [data-phase],${dark} .hHd-Xa_root{background:transparent!important}
